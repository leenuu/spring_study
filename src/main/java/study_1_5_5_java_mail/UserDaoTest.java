...
//    @Before
    public void setUp() {
        this.user1 = new User("leenuu", "kang", "404", Level.BASIC, 1, 0, "kangjoon10@gmail.com");
        this.user2 = new User("donas", "kim", "not", Level.SILVER, 55, 10, "kangjoon10@gmail.com");
        this.user3 = new User("pgn", "hong", "found", Level.GOLD, 40, 40, "kangjoon10@gmail.com");
    }
//    @Test
    public void update() {
        dao.reset();
